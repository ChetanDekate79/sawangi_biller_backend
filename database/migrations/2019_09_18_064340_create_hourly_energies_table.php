...
class CreateHourlyEnergiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('hourly_energies', function (Blueprint $table) {
           // $table->bigIncrements('id');
            ...
            $table->primary(['device_id','logger_id','date','hour']);
            $table->unique(['device_id','logger_id','date','hour']);
    ...
    {
        Schema::dropIfExists('hourly_energies');
    }
}
