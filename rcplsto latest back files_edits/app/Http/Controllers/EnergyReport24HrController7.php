...
class EnergyReport24HrController7 extends Controller
{
    //
...
public function genrateHTML($arr){
      ...
      // exit;
       ...
       $now_date1=$carbon->subDays(1);
     $now_date1= Carbon::parse($now_date1)->format("Y-m-d");
        $html_page['head'] = '
        <head>

        <title>  RC Plasto -'.$date.'-'.$now_date1.'</title>
        ...
        $html_page['heading'] ='
            ...
            <center>
                <div>
                    ...
                    <h3 >Hourly Energy Report For Date - '.$now_date1.' 7 am-'.$date.' 7am </h3>
                </div>
            </center><hr>';
            ;
        ...
        $t_head1 ='<thead >
                        ...
                        <th>category</th>
                        <th>Device\Hour</th>
                        <th>1 (00:00 to 01:00) '.$date.'</th>
                        <th>2 (01:00 to 02:00) '.$date.'</th>
                        <th>3 (02:01 to 03:00) '.$date.'</th>
                        <th>4 (03:01 to 04:00) '.$date.'</th>
                        <th>5 (04:01 to 05:00) '.$date.'</th>
                        <th>6 (05:01 to 06:00) '.$date.'</th>
                        <th>7 (06:01 to 07:00) '.$date.'</th>
                        <th>8 (07:01 to 08:00) '. $now_date1.'</th>
                        <th>9 (08:01 to 09:00) '. $now_date1.'</th>
                        <th>10 (09:01 to 10:00) '. $now_date1.'</th>
                        <th>11 (10:01 to 10:00) '. $now_date1.'</th>
                        <th>12 (11:01 to 12:00) '. $now_date1.'</th>
                        <th>13 (12:01 to 13:00) '. $now_date1.'</th>
                        <th>14 (13:01 to 14:00) '. $now_date1.'</th>
                        <th>15 (14:01 to 15:00) '. $now_date1.'</th>
                        <th>16 (15:01 to 16:00) '. $now_date1.'</th>
                        <th>17 (16:01 to 17:00) '. $now_date1.'</th>
                        <th>18 (17:01 to 18:00) '. $now_date1.'</th>
                        <th>19 (18:01 to 19:00) '. $now_date1.'</th>
                        <th>20 (19:01 to 20:00) '. $now_date1.'</th>
                        <th>21 (20:01 to 21:00) '. $now_date1.'</th>
                        <th>22 (21:01 to 22:00) '. $now_date1.'</th>
                        <th>23 (22:01 to 23:00) '. $now_date1.'</th>
                        <th>24 (23:01 to 24:00) '. $now_date1.'</th>
...
//     }
    ...
    public function commanAreaEnergy($date){
      ...
      $now_date1= Carbon::parse($now_date1)->format("Y-m-d");
         return DB::select("
         SELECT * from ( (select T2.sort_order,level_no,T1.device_id, device_name, T1.hour, cast(dt_time as date) as date ,
            ...
            from (SELECT device_id, hour, dt_time ,kwh
                from	 data_rs485_summary
                    WHERE cast(DT_TIME as date) = '$now_date1'
                ) T1  join
            ...
            (select T2.sort_order,level_no,T1.device_id, device_name, T1.hour, cast(dt_time as date) as date ,
                kwh,round(col_total) as col_total , round(row_total) as row_total ,device_category as category , type,category_color,type as category_code
            from (SELECT device_id, hour, dt_time ,kwh
                from	 data_rs485_summary
            ...
            on T1.hour = T3.hour
            WHERE T1.hour>7
            order by hour,level_no,type,T2.sort_order) ) a ORDER BY HOUR,level_no,sort_order
        ");
    }
