    ...
    public function getReport($opration='mail',$date='now',$doc='pdf',$type='try'){
        ...
        if($opration=='mail') {
           ...
           // print_r($email);
            ...
            $filename_arr[0] = $file_name = "Energy Report Safal | Samay | Sambhav , Sausar [DATE- ".$date."].pdf";
            $filename_arr[1] = $file_name = "Productivity Safal | Samay | Sambhav , Sausar [DATE- ".$date."].pdf";
	...
	width:15%;
     border: 0px;
        ...
        $html_page['heading'] ='
                ...
                <table>
                    <tr>
                        ...
                        <td  class="std txt-align" style="text-align: right;">
                            <span style=" ">
                        <img   width="100px" src="http://suruchi.hetadatain.com/assets/client_logo.png" id=""></span>
                        </td>
                    </tr>
                </table>
            </div>
            <center>
                <div>
                    <h2>Safal | Samay | Sambhav , Sausar</h2>
...
public function reportFeedersEnergy($date){
    ...
    return DB::select("
        ...
        on T2.device_id = T3.device_id order by level_no , category_code,indexs,T1.kwh desc;
