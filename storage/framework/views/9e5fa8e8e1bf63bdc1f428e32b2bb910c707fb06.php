...
<body>
    ...
    <form id="pdfDownloadForm" action="<?php echo e(route('student_no_consumption_report')); ?>" method="POST" style="display: none;">
        <?php echo csrf_field(); ?>
...
<?php /**PATH F:\wardha\Sawangi_Biller_Backend\resources\views/student_no_consumption_report.blade.php ENDPATH**/ ?>