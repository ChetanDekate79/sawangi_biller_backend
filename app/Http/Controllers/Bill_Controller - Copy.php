...
class Bill_Controller extends Controller
{
    public function Monthly_Bill($hostel, $room, $month, $year, $rate, $comm_area){
        ...
        $studentIdsQuery = "SELECT DISTINCT S.student_id,S.room_no FROM (
        ...
        $studentIdsQuery2 = "SELECT DISTINCT S.student_id FROM (
...
//     $result2 = $this->monthly_bill_complete($hostel, $room_no, $month,$year, $rate, $comm_area, $quotedStudentIds2);
//     // $combinedResult = [
//     //     $result,
//     //     $result2,
//     // ];

//     $combinedResult = $result + $result2;
...
public function monthly_bill_complete($hostel,$room,$month,$year,$rate,$comm_area, $commaSeparatedIds){
